...
report 50003 "Sales Quote (Newtronic)"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(No__of_Archived_Versions; FORMAT("No. of Archived Versions"))
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                column(ShipmentDate_Line; "Expected Delivery")
                {
                }
    ...
    var
        ...
        ItemAltNoLbl: TextConst DAN = 'Alt.nr.', DEU = 'Alt. Nr.', ENU = 'Alt. Nr.';
        ...
        DocumentTitleLbl: TextConst DAN = 'Tilbud', DEU = 'Angebot', ENU = 'Quote';
        ...
        PostedShipmentDateLbl: TextConst DAN = 'Forventet levering', ENU = 'Expected Shipment';
