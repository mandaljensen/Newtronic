...
report 50005 "Sales Shipment (Newtronic)"
{
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            RequestFilterHeadingML = DAN = 'Bogført salgsleverance', ENU = 'Posted Sales Shipment';
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SalesShptCopyText; DocumentTitleLbl)
                    {
                    }
                    ...
                    column(VATRegNoCaption; CompanyInfo.GetVATRegistrationNumberLbl)
                    {
                    }
                    ...
                    column(ShipmentNoCaption; ShipmentNoCaption)
                    {
                    }
                    ...
                    column(DocumentDateCaption; DocDateCaption)
                    {
                    }
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(Qty_SalesShptLineCaption; QtyLbl)
                        {
                        }
                        column(UOM_SalesShptLineCaption; UnitLbl)
                        {
                        }
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(NoOfCopies; NoOfCopies)
                    {
                        ...
                        CaptionML = DAN = 'Antal kopier', ENU = 'No. of Copies';
                        ToolTipML = DAN = 'Angiver, hvor mange kopier af bilaget der udskrives.', ENU = 'Specifies how many copies of the document to print.';
                    }
                    field(ShowInternalInfo; ShowInternalInfo)
                    {
                        ApplicationArea = Basic, Suite;
                        CaptionML = DAN = 'Vis interne oplysninger', ENU = 'Show Internal Information';
                        ToolTipML = DAN = 'Angiver, om bilaget viser interne oplysninger.', ENU = 'Specifies if the document shows internal information.';
                    }
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        CaptionML = DAN = 'Vis rettelseslinjer', ENU = 'Show Correction Lines';
                        ToolTipML = DAN = 'Angiver, om rettelseslinjerne for en tilbageførsel af antalsposteringen vises i rapporten.', ENU = 'Specifies if the correction lines of an undoing of quantity posting will be shown on the report.';
                    }
                    field(ShowLotSN; ShowLotSN)
                    {
                        ApplicationArea = Basic, Suite;
                        CaptionML = DAN = 'Vis appendiks for serie-/lotnummer', ENU = 'Show Serial/Lot Number Appendix';
                        ToolTipML = DAN = 'Angiver, om du vil udskrive et appendiks til salgsleverancerapporten, der viser leverancens lot- og serienumre.', ENU = 'Specifies if you want to print an appendix to the sales shipment report showing the lot and serial numbers in the shipment.';
                    }
                    field(DisplayAsmInfo; DisplayAssemblyInformation)
                    {
                        ApplicationArea = Assembly;
                        CaptionML = DAN = 'Vis montagekomponenter', ENU = 'Show Assembly Components';
                        ToolTipML = DAN = 'Angiver, om rapporten skal omfatte oplysninger om komponenter, der blev brugt i sammenkædede montageordrer, hvori den eller de solgte varer indgik.', ENU = 'Specifies if you want the report to include information about components that were used in linked assembly orders that supplied the item(s) being sold.';
                    }
                }
            }
        }
    ...
    var
        ...
        OurDocumentNoLbl: TextConst DAN = 'Vores bilagsnr.', ENU = 'Our Document No.';
        PurchaseOrderNoLbl: TextConst DAN = 'Eksternt bilagsnr.', ENU = 'External Document No.';
        DocumentTitleLbl: TextConst DAN = 'Salgsleverance', DEU = 'Verkaufslieferung', ENU = 'Sales Shipment';
        PageCaptionCap: TextConst DAN = 'Side %1 af ', DEU = 'Seite %1 von ', ENU = 'Page %1 of ';
        ...
        QtyLbl: TextConst DAN = 'Antal', DEU = 'Anzahl', ENU = 'Quantity.';
        EmailCaptionLbl: TextConst DAN = 'Email', ENU = 'Email';
        HomePageCaptionLbl: TextConst DAN = 'Hjemmeside', ENU = 'Home Page';
        DocDateCaption: TextConst DAN = 'Bilagsdato', ENU = 'Document Date';
        ShipmentNoCaption: TextConst DAN = 'Leverancenr.', ENU = 'Shipment No.';
        ShipmentDateCaption: TextConst DAN = 'Afsendelsesdato', ENU = 'Shipment Date';
